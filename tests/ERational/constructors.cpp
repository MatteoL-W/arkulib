...
TEST (ArkulibERationalConstructor, NumAndDen) {
    ...
    Arkulib::ERational r3{(long long int) 4342434324432, (long long int) 314347483689};
    ...
    Arkulib::ERational r4{(long long int) 4342434324432, (long long int) 314347483689, true};
